...
const Discover = () => {
  ...
  const [activeTab, setActiveTab] = useState(tabFromUrl === 'groups' ? 'groups' : 'buddies');
      ...
      <div className="p-4 lg:p-8">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
          <div>
            ...
            <p className="text-muted-foreground">
              Find study buddies and small groups that match your style
            </p>
          </div>
        ...
        <Tabs value={activeTab} onValueChange={handleTabChange} className="space-y-6">
          <TabsList className="grid w-full max-w-md grid-cols-2">
            <TabsTrigger value="buddies">Potential Buddies</TabsTrigger>
            ...
            {recommendedPeople.length > 0 ? (
              ...
              <div className="bg-card rounded-xl p-8 border border-border/50 text-center">
                ...
                <p className="text-sm text-muted-foreground mb-4 max-w-sm mx-auto">
                  Add more courses or adjust your availability in profile settings to see better
                  matches.
                </p>
